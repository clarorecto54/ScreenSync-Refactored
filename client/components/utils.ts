import { DrawLineProps } from "@/types/annotation.types"
...
/* -------- DRAW LINE ------- */
export function drawLine({ context, currentPoint, prevPoint, lineWidth, color }: DrawLineProps) {
    ...
    context.strokeStyle = color     //? Set the stroke color for the line connecting the points
    ...
    context.fillStyle = color   //? Set the fill color for the point
